...
HOTLIST_TARGET = env_int("STEAMKB_HOTLIST_TARGET", 200, minimum=100, maximum=200)
HOTLIST_CONCURRENCY = env_int("STEAMKB_HOTLIST_CONCURRENCY", 1, minimum=1, maximum=1)
...
HOT_METADATA_CONCURRENCY = env_int("STEAMKB_HOT_METADATA_CONCURRENCY", 1, minimum=1, maximum=1)
...
SPECIAL_FREE_APPIDS = frozenset({1422450})  # Deadlock: restricted Store/player endpoints.
SPECIAL_APP_REFRESH_MINUTES = env_int("STEAMKB_SPECIAL_APP_REFRESH_MINUTES", 15, minimum=5, maximum=240)
...
CATALOG_ENRICH_DAILY_LIMIT = env_int("STEAMKB_CATALOG_ENRICH_DAILY_LIMIT", 2000, minimum=100)
...
DEAL_POOL_DISPLAY_LIMIT = env_int("STEAMKB_DEAL_POOL_DISPLAY_LIMIT", 200, minimum=20, maximum=500)
DEAL_POOL_CANDIDATE_LIMIT = env_int("STEAMKB_DEAL_POOL_CANDIDATE_LIMIT", 800, minimum=100, maximum=2000)
DEAL_HIGH_REVIEW_MIN = env_int("STEAMKB_DEAL_HIGH_REVIEW_MIN", 90, minimum=1, maximum=100)
DEAL_POOL_MIN_REVIEWS = env_int("STEAMKB_DEAL_POOL_MIN_REVIEWS", 500, minimum=1)
DEAL_POOL_MIN_PLAYERS = env_int("STEAMKB_DEAL_POOL_MIN_PLAYERS", 500, minimum=1)
DEAL_HIGH_REVIEW_MIN_REVIEWS = env_int("STEAMKB_DEAL_HIGH_REVIEW_MIN_REVIEWS", 1000, minimum=1)
...
PLAYER_DAILY_REQUEST_BUDGET = env_int("STEAMKB_PLAYER_DAILY_REQUEST_BUDGET", 7500, minimum=100, maximum=30000)
PRICE_DAILY_REQUEST_BUDGET = env_int("STEAMKB_PRICE_DAILY_REQUEST_BUDGET", 7500, minimum=20, maximum=30000)
COVERAGE_PLAYER_BATCH_LIMIT = env_int("STEAMKB_COVERAGE_PLAYER_BATCH_LIMIT", 160, minimum=1, maximum=250)
COVERAGE_PRICE_BATCH_LIMIT = env_int("STEAMKB_COVERAGE_PRICE_BATCH_LIMIT", 20, minimum=1, maximum=100)
COVERAGE_BACKGROUND_COHORT_LIMIT = env_int("STEAMKB_COVERAGE_BACKGROUND_COHORT_LIMIT", 8000, minimum=100, maximum=20000)
COVERAGE_ACTIVITY_DAYS = env_int("STEAMKB_COVERAGE_ACTIVITY_DAYS", 14, minimum=1, maximum=90)
PLAYER_REQUEST_DELAY_SECONDS = env_float("STEAMKB_PLAYER_REQUEST_DELAY_SECONDS", 0.3, minimum=0)
DISCOUNT_EXPIRY_BATCH_LIMIT = env_int("STEAMKB_DISCOUNT_EXPIRY_BATCH_LIMIT", 4, minimum=1, maximum=10)
DISCOUNT_EXPIRY_RETRY_HOURS = env_int("STEAMKB_DISCOUNT_EXPIRY_RETRY_HOURS", 24, minimum=1, maximum=168)
STORE_HTML_MAX_BYTES = env_int("STEAMKB_STORE_HTML_MAX_BYTES", 3 * 1024 * 1024, minimum=256 * 1024, maximum=8 * 1024 * 1024)
...
MEME_UPLOAD_MAX_BYTES = env_int("STEAMKB_MEME_UPLOAD_MAX_BYTES", 10 * 1024 * 1024, minimum=256 * 1024, maximum=25 * 1024 * 1024)
MEME_MAX_FILES = env_int("STEAMKB_MEME_MAX_FILES", 300, minimum=1, maximum=2000)
MEME_MAX_TOTAL_BYTES = env_int("STEAMKB_MEME_MAX_TOTAL_BYTES", 256 * 1024 * 1024, minimum=16 * 1024 * 1024, maximum=2 * 1024 * 1024 * 1024)
