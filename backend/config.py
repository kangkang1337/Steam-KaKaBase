...
PLAYER_DAILY_REQUEST_BUDGET = env_int("STEAMKB_PLAYER_DAILY_REQUEST_BUDGET", 5000, minimum=100, maximum=20000)
PRICE_DAILY_REQUEST_BUDGET = env_int("STEAMKB_PRICE_DAILY_REQUEST_BUDGET", 600, minimum=20, maximum=5000)
